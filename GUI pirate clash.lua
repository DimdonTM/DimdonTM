game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Pirate Clash GUI", Text = "Hello, people!"})
...
Section:NewButton("Hitbox", "REALLY GOD BOY)", function()
	game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Pirate Clash Hitbox", Text = "t = Enabled : p = disabled."})
	game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Reworked by Dimdon", Text = "have a nice day :3"})
